...
WebUI.setText(findTestObject('Add user/Page_OrangeHRM/Page_OrangeHRM/Add_input_Username'), 'BayuTest')
...
WebUI.verifyElementVisible(findTestObject('Add user/Page_OrangeHRM/Page_OrangeHRM/Add_span_Required'))
