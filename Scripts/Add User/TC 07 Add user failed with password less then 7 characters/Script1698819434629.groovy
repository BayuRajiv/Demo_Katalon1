...
WebUI.setText(findTestObject('Add user/Page_OrangeHRM/Page_OrangeHRM/Add_input_Username'), 'Baybay')

WebUI.setEncryptedText(findTestObject('Add user/Page_OrangeHRM/Page_OrangeHRM/Add_input_Password'), 'J7R4ejOak4Y=')

WebUI.setEncryptedText(findTestObject('Add user/Page_OrangeHRM/Page_OrangeHRM/Add_input_Confirm Password'), 'J7R4ejOak4Y=')
